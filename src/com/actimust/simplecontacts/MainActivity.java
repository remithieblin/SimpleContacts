...
//		 startActivityForResult(intent, SOME_REQUEST_CODE);
		...
		for (Account account : accounts) 
		    if (account.type.equals(accountType) && emailPattern.matcher(account.name).matches()) 
	...
	private final class AnActionModeOfEpicProportions implements
		...
		public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
			Toast.makeText(MainActivity.this, "Got click: " + item, Toast.LENGTH_SHORT)
					.show();
			mode.finish();
			return true;
		}
		...
		public void onDestroyActionMode(ActionMode mode) {
			...
			Toast.makeText(MainActivity.this, "Contact saved", Toast.LENGTH_SHORT)
					.show();
			actionModeUp = false;
		}
...
//	            CharSequence txt = getString(R.string.contactCreationFailure);
	            ...
	            Toast toast = Toast.makeText(ctx, "Could not create contact: " + e.getMessage(), duration);
	            toast.show();
